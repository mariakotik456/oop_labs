...
Orc::Orc(const std::string &name, int x, int y) : NPC(name, x, y, 20, 10) {}
...
Bear::Bear(const std::string &name, int x, int y) : NPC(name, x, y, 5, 10) {}
...
Squirrel::Squirrel(const std::string &name, int x, int y) : NPC(name, x, y, 5, 5) {}
